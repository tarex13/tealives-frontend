                            ...
                            >
                              ...
                              {m.attachment_url && (
                                  isImageUrl(m.attachment_url)
                                    ? <img src={m.attachment_url} className="mb-2 rounded max-h-40" />
                                      ...
                                      <p className="text-sm whitespace-pre-wrap break-words">
                                        ...
                                        {extractUrl(m.content) && (
                                          <div className="border rounded p-2 mt-2 hover:bg-gray-700 transition">
                                            <a href={extractUrl(m.content)} target="_blank" rel="noopener noreferrer"
                    ...
                    {(m.reactions_summary||[]).map(r => (
                      <button key={r.emoji}
                        ...
                        className={`
                          ...
                          transition
                        `}>
                        <span>{r.emoji}</span><span className="text-2xs">{r.count}</span>
                      </button>
                    ))}
